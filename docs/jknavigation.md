...
<html>
	...
	<body>
		...
		<script type="text/javascript" src="chordly-1.0.0.js"></script>
		<script type="text/javascript">  
		    ...
		    $(document).ready(function () {
		        ...
		        $document.chordly('bindSequence', 'J', function () {
		            jkNavigate(true);

		        });

		        // navigate with 'k' for previous
		        $document.chordly('bindSequence', 'K', function () {
		            jkNavigate(false);
		        });

		        // activate jk navigation element on enter
		        $document.chordly('bindSequence', 'Enter', function () {
		        ...
		        $document.chordly('bindSequence', 'Esc', function () {
